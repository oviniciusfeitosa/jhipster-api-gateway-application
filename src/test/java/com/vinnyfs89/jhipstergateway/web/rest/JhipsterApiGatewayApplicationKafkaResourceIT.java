...
public class JhipsterApiGatewayApplicationKafkaResourceIT {
    ...
    @Autowired
    private JhipsterApiGatewayApplicationKafkaProducer producer;

    @Autowired
    private JhipsterApiGatewayApplicationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterApiGatewayApplicationKafkaResource kafkaResource = new JhipsterApiGatewayApplicationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-api-gateway-application-kafka/publish?message=test"))
